...
<div class="min-h-screen bg-gradient-to-br from-amber-50 to-orange-50 dark:from-gray-900 dark:to-gray-800 py-8">
    <div class="container mx-auto px-4">
        ...
        <div class="text-center mb-8">
            <h1 class="text-3xl font-bold text-gray-900 dark:text-white mb-2">Создание нового ранга</h1>
            <p class="text-gray-600 dark:text-gray-400">Настройте параметры ранга для пользователей</p>
        </div>

        <!-- Form Container -->
        <div class="form-container">
            <div class="form-description">
                <p><i class="fas fa-info-circle mr-2"></i>Создайте новый ранг с уникальными привилегиями и требованиями для пользователей</p>
            </div>
            ...
            <form action="{{ route('admin.ranks.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text"
                           ...
                           id="name"
                           class="form-control"
                           placeholder="Например: Новичок, Профи, Мастер"
                           required>
                </div>
...
// Auto-calculate max from min
document.getElementById('oborot_min').addEventListener('input', function() {
    const minValue = parseInt(this.value) || 0;
    const maxInput = document.getElementById('oborot_max');
    if (!maxInput.value || parseInt(maxInput.value) <= minValue) {
        maxInput.value = minValue + 1000;
    }
});

// Auto-calculate daily max from min
document.getElementById('daily_min').addEventListener('input', function() {
    const minValue = parseFloat(this.value) || 0;
    const maxInput = document.getElementById('daily_max');
    if (!maxInput.value || parseFloat(maxInput.value) <= minValue) {
        maxInput.value = (minValue + 5).toFixed(2);
    }
});
</script>
