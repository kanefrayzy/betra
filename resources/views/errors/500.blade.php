            ...
            <div class="max-w-4xl mx-auto">
                <div class="bg-[#1e2329] rounded-2xl border border-gray-800 overflow-hidden">
                    ...
                    <div class="p-6 space-y-3">
                        ...
                        <a href="javascript:void(0);" onclick="location.reload()" class="flex items-center gap-4 group hover:bg-gray-800/30 p-4 rounded-lg transition-colors">
                            <div class="flex-shrink-0 w-12 h-12 bg-[#ffb300]/10 rounded-lg flex items-center justify-center text-[#ffb300]">
                                <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <div class="flex-1">
                                <p class="text-white font-semibold group-hover:text-[#ffb300] transition-colors">{{ __('Обновить страницу') }}</p>
