<x-layouts.app>
    <div class="bg-[#0f212e] py-8 md:py-12 min-h-screen">
        <div class="mx-auto px-4">
            <div class="text-center mb-12">
                ...
                <h1 class="text-3xl md:text-4xl font-bold text-white mb-4">
                    500 - {{ __('Ошибка сервера') }}
                </h1>
                <p class="text-gray-400 text-lg max-w-2xl mx-auto">
                    {{ __('Произошла внутренняя ошибка сервера. Наши специалисты уже работают над её устранением. Пожалуйста, попробуйте позже.') }}
                </p>
            </div>
            ...
            <div class="max-w-4xl mx-auto">
                <div class="bg-[#1a2c38] rounded-2xl border border-[#2d3748] overflow-hidden">
                    ...
                    <div class="p-6 space-y-3">
                        ...
                        <a href="javascript:void(0);" onclick="location.reload()" class="flex items-center gap-4 group hover:bg-[#2d3748]/50 p-4 rounded-lg transition-colors">
                            <div class="flex-shrink-0 w-12 h-12 bg-[#3b82f6]/10 rounded-lg flex items-center justify-center text-[#3b82f6]">
                                <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2">
                            ...
                            <div class="flex-1">
                                <p class="text-white font-semibold group-hover:text-[#3b82f6] transition-colors">{{ __('Обновить страницу') }}</p>
                                <p class="text-gray-400 text-sm">{{ __('Попробовать снова') }}</p>
                            </div>
                            <svg class="w-5 h-5 text-gray-600 group-hover:text-[#3b82f6] transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M9 5l7 7-7 7"/>
                            </svg>
