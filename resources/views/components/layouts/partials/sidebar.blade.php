    ...
    <div class="flex items-center gap-2 p-4">
        ...
        <div class="flex items-center gap-2 flex-1 sidebar-nav-buttons">
            <a href="{{ route('slots.lobby') }}" 
               ...
               x-show="!$root.sidebarCollapsed || window.innerWidth < 1280">
                {{ __('Казино') }}
            </a>
            <a href="#" 
               style="background: #2f4553;"
    ...
    <div class="flex-1 overflow-y-auto px-3 pb-6 custom-scrollbar">
        ...
        <div class="mb-4 bg-[#1a2c38] rounded-lg p-2 space-y-1">
            <a href="{{ route('slots.history') }}"
               ...
               x-tooltip="$root.sidebarCollapsed ? '{{ __('Недавние') }}' : ''">
                <svg class="h-5 w-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <circle cx="12" cy="12" r="10"/>
                    <polyline points="12 6 12 12 16 14"/>
                </svg>
                <span x-show="!$root.sidebarCollapsed" class="truncate">{{ __('Недавние') }}</span>
            </a>
            ...
            <a href="{{ route('slots.popular') }}"
               ...
               x-tooltip="$root.sidebarCollapsed ? '{{ __('Популярные') }}' : ''">
               <svg class="h-5 w-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <span x-show="!$root.sidebarCollapsed" class="truncate">{{ __('Популярные') }}</span>
            </a>
            ...
            <a href="{{ route('slots.new') }}"
               ...
               x-tooltip="$root.sidebarCollapsed ? '{{ __('Новые') }}' : ''">
                <svg class="h-5 w-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <circle cx="12" cy="12" r="10"/>
                    <line x1="12" y1="8" x2="12" y2="16"/>
                    <line x1="8" y1="12" x2="16" y2="12"/>
                </svg>
                <span x-show="!$root.sidebarCollapsed" class="truncate">{{ __('Новые') }}</span>
            </a>
            ...
            <a href="{{ route('slots.favorites') }}"
               ...
               x-tooltip="$root.sidebarCollapsed ? '{{ __('Избранные') }}' : ''">
                <svg class="h-5 w-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path d="M19 21l-7-5-7 5V5a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2z"/>
                </svg>
                <span x-show="!$root.sidebarCollapsed" class="truncate">{{ __('Избранные') }}</span>
            </a>
        </div>
        @endauth
        ...
        <div class="mb-4 bg-[#1a2c38] rounded-lg p-2">
            <div class="space-y-1">
                <a href="{{ route('slots.lobby') }}"
                   ...
                   x-tooltip="$root.sidebarCollapsed ? '{{ __('Все слоты') }}' : ''">
                    ...
                    <span x-show="!$root.sidebarCollapsed" class="truncate">{{ __('Все слоты') }}</span>
                </a>
                ...
                <a href="{{ route('slots.category', $cat->slug) }}"
                   ...
                   x-tooltip="$root.sidebarCollapsed ? '{{ __($cat->name) }}' : ''">
                    @if($cat->icon)
                    ...
                    @endif
                    <span x-show="!$root.sidebarCollapsed" class="truncate">{{ __($cat->name) }}</span>
                </a>
                @endforeach
            </div>
        </div>
        ...
        <div class="mb-4 bg-[#1a2c38] rounded-lg p-2">
            <div class="space-y-1">
                <a href="javascript:void(0);" 
                   ...
                   class="sidebar-item"
                   x-tooltip="$root.sidebarCollapsed ? '{{ __('Бонус') }}' : ''">
                    <svg class="h-5 w-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <circle cx="12" cy="12" r="10"/>
                    ...
                    <span x-show="!$root.sidebarCollapsed" class="truncate">{{ __('Бонус') }}</span>
                </a>

                <a href="javascript:void(0);" 
                   onclick="openRankModal(); document.body.classList.remove('sidebar-open')" 
                   class="sidebar-item"
                   x-tooltip="$root.sidebarCollapsed ? '{{ __('Уровень') }}' : ''">
                    <svg class="h-5 w-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"/>
                    </svg>
                    <span x-show="!$root.sidebarCollapsed" class="truncate">{{ __('Уровень') }}</span>
                </a>

                <a href="javascript:void(0);" 
                   onclick="openPromoModal(); document.body.classList.remove('sidebar-open')" 
                   class="sidebar-item"
                   x-tooltip="$root.sidebarCollapsed ? '{{ __('Промо') }}' : ''">
                    <svg class="h-5 w-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <span x-show="!$root.sidebarCollapsed" class="truncate">{{ __('Промо') }}</span>
                </a>
                ...
                <a href="{{ route('account.referrals') }}"
                   ...
                   x-tooltip="$root.sidebarCollapsed ? '{{ __('Партнерам') }}' : ''">
                    <svg class="h-5 w-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path d="M16 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/>
                        <circle cx="8.5" cy="7" r="4"/>
                        <polyline points="17 11 19 13 23 9"/>
                    </svg>
                    <span x-show="!$root.sidebarCollapsed" class="truncate">{{ __('Партнерам') }}</span>
                </a>

                <a href="javascript:void(0);" 
                   onclick="window.openModalWithMyInfo(); document.body.classList.remove('sidebar-open')" 
                   class="sidebar-item"
                   x-tooltip="$root.sidebarCollapsed ? '{{ __('Статистика') }}' : ''">
                    <svg class="h-5 w-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <line x1="18" y1="20" x2="18" y2="10"/>
                        <line x1="12" y1="20" x2="12" y2="4"/>
                        <line x1="6" y1="20" x2="6" y2="14"/>
                    </svg>
                    <span x-show="!$root.sidebarCollapsed" class="truncate">{{ __('Статистика') }}</span>
                </a>
                ...
                <a href="{{ route('transaction') }}"
                   ...
                   x-tooltip="$root.sidebarCollapsed ? '{{ __('Транзакции') }}' : ''">
                    <svg class="h-5 w-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <line x1="12" y1="1" x2="12" y2="23"/>
                        <path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"/>
                    </svg>
                    <span x-show="!$root.sidebarCollapsed" class="truncate">{{ __('Транзакции') }}</span>
                </a>
                ...
                <a href="{{ route('account') }}"
                   ...
                   x-tooltip="$root.sidebarCollapsed ? '{{ __('Настройки') }}' : ''">
                    <svg class="h-5 w-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/>
                        <circle cx="12" cy="7" r="4"/>
                    </svg>
                    <span x-show="!$root.sidebarCollapsed" class="truncate">{{ __('Настройки') }}</span>
                </a>
                ...
                <a href="{{ route('auth.logout') }}" 
                   ...
                   x-tooltip="$root.sidebarCollapsed ? '{{ __('Выход') }}' : ''">
                    ...
                    <span x-show="!$root.sidebarCollapsed" class="truncate">{{ __('Выход') }}</span>
                </a>
            </div>
        </div>
        @endauth
        ...
        <div class="mb-6 border-t border-gray-800 pt-4">
            <a href="https://t.me/flashgame_support_bot" 
               target="_blank" 
               class="sidebar-item"
               x-tooltip="$root.sidebarCollapsed ? '{{ __('Поддержка') }}' : ''">
                <svg class="h-5 w-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/>
                </svg>
                <span x-show="!$root.sidebarCollapsed" class="truncate">{{ __('Поддержка') }}</span>
            </a>
            ...
            <a href="https://t.me/{{ $settings->support_tg }}" 
               ...
               rel="noopener" 
               class="sidebar-item"
               x-tooltip="$root.sidebarCollapsed ? '{{ __('Telegram канал') }}' : ''">
                <svg class="h-5 w-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <span x-show="!$root.sidebarCollapsed" class="truncate">{{ __('Telegram канал') }}</span>
            </a>
            @endif
            ...
            <a href="{{ route('rules') }}"
               ...
               @click="sidebarOpen = false"
               class="sidebar-item"
               x-tooltip="$root.sidebarCollapsed ? '{{ __('Правила') }}' : ''">
                <svg class="h-5 w-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <span x-show="!$root.sidebarCollapsed" class="truncate">{{ __('Правила') }}</span>
            </a>
        </div>
            ...
            <div x-data="{ open: false }" class="relative">
                <div x-show="open"
                    ...
                    <div class="grid gap-1 p-2" :class="$root.sidebarCollapsed ? 'grid-cols-1' : 'grid-cols-3'">
                        ...
                        <a href="/setlocale/en"  class="flex flex-col items-center p-2 rounded hover:bg-gray-800 text-gray-400 hover:text-white transition">
                            ...
                            <span class="text-[10px] uppercase" x-show="!$root.sidebarCollapsed">EN</span>
                        </a>
                        <a href="/setlocale/tr"  class="flex flex-col items-center p-2 rounded hover:bg-gray-800 text-gray-400 hover:text-white transition">
                            ...
                            <span class="text-[10px] uppercase" x-show="!$root.sidebarCollapsed">TR</span>
                        </a>
                        <a href="/setlocale/az"  class="flex flex-col items-center p-2 rounded hover:bg-gray-800 text-gray-400 hover:text-white transition">
                            ...
                            <span class="text-[10px] uppercase" x-show="!$root.sidebarCollapsed">AZ</span>
                        </a>
                        <a href="/setlocale/kz"  class="flex flex-col items-center p-2 rounded hover:bg-gray-800 text-gray-400 hover:text-white transition">
                            ...
                            <span class="text-[10px] uppercase" x-show="!$root.sidebarCollapsed">KZ</span>
                        </a>
                        <a href="/setlocale/uz"  class="flex flex-col items-center p-2 rounded hover:bg-gray-800 text-gray-400 hover:text-white transition">
                            ...
                            <span class="text-[10px] uppercase" x-show="!$root.sidebarCollapsed">UZ</span>
                        </a>
                    </div>
                </div>
                ...
                <button @click.stop="open = !open" 
                    ...
                    <div class="flex items-center gap-2">
                        ...
                        <span class="uppercase text-sm" x-show="!$root.sidebarCollapsed">
