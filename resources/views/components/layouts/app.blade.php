    ...
    <head>
        ...
        <!-- Preconnect для игровых провайдеров (на страницах игр) -->
        @if(request()->routeIs('slots.play', 'slots.fun'))
    ...
    <body x-data="{ sidebarOpen: false }" 
        ...
        <div x-show="sidebarOpen"
            ...
            <div class="flex-1 flex flex-col overflow-hidden main-content relative" 
                ...
                <main id="main-content-wrapper" class="relative container mx-auto flex-1 overflow-x-hidden overflow-y-auto bg-[#0f212e] px-1 transition-opacity duration-300">
                    {{ $slot }}
                </main>
