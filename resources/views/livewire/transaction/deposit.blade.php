<div class="min-h-screen py-8">
    <div class="container mx-auto px-4 max-w-7xl">
        ...
        <div class="mb-8">
            <h1 class="text-3xl md:text-4xl font-bold text-white mb-2">{{ __('Депозиты') }}</h1>
                                ...
                                <tr class="hover:bg-[#2d3748]/30 transition group">
                                    ...
                                    <td class="py-4 px-6">
                                        <div class="flex items-center gap-3">
                                            <div class="w-10 h-10 rounded-lg bg-[#4dda30]/10 flex items-center justify-center flex-shrink-0">
                                ...
                                <tr>
                                    <td colspan="5" class="py-20 text-center">
                                        <div class="flex flex-col items-center justify-center">
                                            ...
                                            <p class="text-gray-500 text-sm">{{ __('История депозитов пуста') }}</p>
                                        </div>
                                    </td>
                                </tr>
                            @endforelse
                    ...
                    @forelse($transactions as $transaction)
                        <div class="p-4 hover:bg-[#2d3748]/30 transition">
                            ...
                            <div class="flex items-start justify-between mb-3">
                                <div class="flex items-center gap-3">
                                    <div class="w-12 h-12 rounded-lg bg-[#4dda30]/10 flex items-center justify-center flex-shrink-0">
                                        <svg class="w-6 h-6 text-[#4dda30]" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2">
                                            <path stroke-linecap="round" stroke-linejoin="round" d="M12 4v16m8-8H4"/>
                                        </svg>
                                    </div>
                                    <div>
