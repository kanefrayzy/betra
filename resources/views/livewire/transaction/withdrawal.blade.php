<div class="min-h-screen py-8">
    <div class="container mx-auto px-4 max-w-6xl">
        <!-- Header -->
        <div class="mb-8">
            <h1 class="text-3xl font-bold text-white mb-2">{{ __('Выводы') }}</h1>
        ...
        <!-- Table Card -->
        <div class="bg-[#1e2329] rounded-2xl shadow-xl overflow-hidden border border-gray-800" wire:poll.1000ms>
            <!-- Desktop Table -->
                            ...
                            <tr>
                                <td colspan="4" class="py-16 text-center">
                                    <div class="flex flex-col items-center justify-center">
                                        ...
                                        <p class="text-gray-400 text-lg font-medium mb-1">{{ __('Нет выводов') }}</p>
                                        <p class="text-gray-600 text-sm">{{ __('История выводов пуста') }}</p>
                                    </div>
                                </td>
                            </tr>
                        @endforelse
