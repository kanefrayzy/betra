 ...
 ">
    ...
    <div class="relative">
        <button
            ...
            class="relative text-gray-400 hover:text-white p-2 rounded-full hover:bg-gray-800 transition-colors notifications-toggle-button"
        ...
        <div x-show="showNotifications"
             ...
             class="absolute right-0 mt-2 w-80 max-h-96 overflow-y-auto bg-[#1e2329] rounded-xl shadow-2xl border border-gray-800 z-50 custom-scrollbar"
            ...
            <div class="p-4 border-b border-gray-800 bg-gradient-to-r from-[#ffb300]/5 to-transparent">
                <div class="flex items-center justify-between">
                    <h3 class="text-sm font-bold text-white">{{ __('Уведомления') }}</h3>
            ...
            <div class="divide-y divide-gray-800">
                ...
                @forelse($notifications as $notification)
                    <div class="p-4 hover:bg-gray-800/50 transition-colors cursor-pointer"
                        ...
                        <div class="flex items-start gap-3">
                            <div class="flex-shrink-0">
                                @switch($notification->data['event'])
                                    ...
                                    @case('level')
                                        <div class="h-10 w-10 rounded-xl bg-[#ffb300]/10 flex items-center justify-center">
                                    ...
                                    @default
                                        <div class="h-10 w-10 rounded-xl bg-gray-500/10 flex items-center justify-center">
