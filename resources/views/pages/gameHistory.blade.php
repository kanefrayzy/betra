...
<div class="head-game">
	...
	<ul>
		<li><a href="/jackpot/history">History</a></li>
		<li><a href="/">Play</a></li>
	</ul>
</div>
<div class="game-info">
...
<div class="jackpot">
	<div class="bank">{{ __('Jackpot игры') }}: <span>{{$history->price}}</span><i class="fas fa-coins"></i></div>
	<div class="second-title"><span>{{ __('Игроки') }}</span></div>
	...
	<div class="timer">
		<div class="timer-title">{{ __('До начала') }}</div>
		<div class="timer-bar">
			<div class="time">
				<div class="elements">
	...
	<div class="winner">
		<div class="second-title"><span>{{ __('Победитель!') }}</span></div>
		<ul>
			<li>
				<div class="chance-w">
					<span class="titles">{{ __('Шанс выигрыша') }}</span>
			...
			<li>
				<div class="winner-w">
					...
					<div class="points">{{ __('Выигрыш') }}: <b>{{$history->winner_sum}}</b> <i class="fas fa-coins"></i></div>
				</div>
			</li>
			<li>
				<div class="ticket-w">
					<span class="titles">{{ __('Счастливый билет') }}</span>
					<span class="ticket"><i class="fas fa-ticket-alt"></i> <b>{{$history->winner_ticket}}</b></span>
				</div>
			</li>
		</ul>
		<div class="check-random">
			<a href="/fair/{{$history->hash}}" class="btn btn-white btn-sm btn-right">{{ __('Проверить') }}</a>
		</div>
	</div>
	<div class="chouser" id="chouser">
		<div class="second-title"><span>{{ __('Выбираем победителя') }}</span></div>
