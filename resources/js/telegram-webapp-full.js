...
if (needsTelegramScript && !window.Telegram) {
...
// Создаем HTML элемент для индикатора загрузки
const loadingDiv = document.createElement('div');
loadingDiv.id = 'telegramAuthLoading';
loadingDiv.className = 'telegram-auth-loading';
